...
3. **E2E 測試**：在將任何功能標記為完成前，必須使用 **Puppeteer / Playwright** 模擬真實用戶操作進行 end-to-end 測試，測試腳本存放於專案指定資料夾，方便日後重複執行
4. **提交 Commit**：測試通過後，用 `git commit` 保存進度
5. **更新進度**：更新 `docs/PROGRESS.md`
6. **確保乾淨狀態**：確認代碼可正常運行後再結束本次工作
